...
BCB_CONNECT_TIMEOUT_SECONDS = env_int("BCB_CONNECT_TIMEOUT_SECONDS", 5)
BCB_READ_TIMEOUT_SECONDS = env_int("BCB_READ_TIMEOUT_SECONDS", 20)
...
FRED_CACHE_TTL = env_int("FRED_CACHE_TTL", 900)
FRED_HISTORY_YEARS = env_int("FRED_HISTORY_YEARS", 3)
